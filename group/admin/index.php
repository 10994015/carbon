...
<body>
	<div class="container">
<a href="index.php" title="" id="logo">學會平台小組</a>
		<br />
		<ol>
		...
		<!-- 印出文章 -->
		<?php if ($articles): ?>
			<?php foreach ($articles as $groups):?>
				<?php echo '<li>' ?>
				<?php echo $groups['article_title']; ?>
				<?php echo "<a href='edit.php?id=". $groups['article_id'] ."'>編輯</a>"?>
				<?php echo "<button onclick='del_func(". $groups['article_id'].")'>刪除</button>"?>
				<?php echo '<br>' ?>
				<?php echo '</li>' ?>
