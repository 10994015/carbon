...
if (isset($_SESSION['logged_in'])) {
		...
		$id = $_GET['id'];
		$query = $pdo->prepare('SELECT * FROM groups WHERE article_id = ?');
...
<body>
	...
	<form method="POST" action="../includes/edit.php?id=<?php echo $id; ?>" accept-charset="utf-8">
		文章標題：<input type="text" name="title"   value=<?php echo $groups['article_title']; ?>>
		<br>
		文章內容：<textarea name="content"><?php echo $groups['article_content']; ?></textarea>
<br>
