...
<head>
	...
	<title>學會平台小組</title>
	<link rel="stylesheet" href="../css/post_group.css">
...
<div class="main-body-fade">  
    ...
    <a href="index.php" title=""><div class="button">理事長的話</div></a>
    <a href="../learn/index.php" title=""><div class="button" >學會簡介</div></a>
    <a href="index.php" title=""><div class="button">組織架構</div></a>
    <a href="../group/index.php" title=""><div class="button" style="background-color: #333;color: #fff;">學會平台小組</div></a>
    ...
    <h1 class="main-body-title">學會平台小組</h1>
    </div>
    <div class="line"></div>
...
<?php 
    ...
    <?php
     ...
     ?> 
      ...
      <h3><?php echo $article['article_title']; ?></h3><br>
