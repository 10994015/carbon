...
<?php
  $db = mysqli_connect("localhost", "root", "10994015", "cms");
    ...
    $datas = array();
    $query = mysqli_query($db, "SELECT * FROM newskonws");
...
<?php
    ...
    foreach ($datas as $data) {
      echo "<li>". mb_substr($data['text1'],0,20,"utf-8") ."<a href=edit.php?id=".$data['id'].">編輯</a>
