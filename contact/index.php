...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/rwdcontact.css">
...
<div class="main-body-fade">
    ...
    <a href="index.php" title=""><div class="button" style="background-color: #333;color: #fff;">聯絡我們</div></a>
     </div>
    <div class="container">
    <a href="index.php" title="" id="logo"></a>
    <div class="img-title">
    <img src="../img/CST Logo.png"  class="img-title-logo">
    <h1 class="main-body-title">聯絡我們</h1>
    </div>
    <div class="line"></div>
...
<?php echo $alert; ?>
    ...
    <p>姓名Name*</p>
    <p><input type="text" name="name" value="" cols="50"></p>
    <br>
    <p>電子郵件Email*</p>
    <p><input name="email" type="email" cols="50"  style="height: 30px;"></p>
    <br>
    <p>留言Message</p>
    <p><textarea name="message" rows="5" cols="50"></textarea></p>
    <br>
   
    <p><input class="submit" type="submit" value="送出Send" name="submit" style=""></p>
