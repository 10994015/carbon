...
<div class="main-body-fade">
    ...
    <a href="../activated/index.php" title=""><div class="button" style="background-color: #333;color: #fff;height: 70px;line-height: 1.5;padding-top: 10px;">活性碳及多孔碳材料</div></a>
    ...
    <h1 class="main-body-title">活性碳及多孔碳材料專區</h1>
    </div>
    <div class="line"></div>
        ...
        <?php foreach ($activated as $article){ ?>
            <li>
...
<?php 
    ...
    $data="select * from activated_images";
