...
<div class="main-body-fade">  
    ...
    <a href="../fiber/index.php" title=""><div class="button" style="background-color: #333;color: #fff;">碳纖維</div></a>
    ...
    <h1 class="main-body-title">碳纖維專區</h1>
    </div>
    <div class="line"></div>
