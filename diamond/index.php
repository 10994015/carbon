...
<div class="main-body-fade">  
    ...
    <a href="../diamond/index.php" title=""><div class="button"  style="background-color: #333;color: #fff;">鑽石薄膜</div></a>
     </div>
    <div class="container">
    <a href="index.php" title="" id="logo"></a>
    <div class="img-title">
    <img src="../img/CST Logo.png"  class="img-title-logo">
    <h1 class="main-body-title">鑽石薄膜專區</h1>
    </div>
    <div class="line"></div>
        ...
        <?php foreach ($diamond as $article){ ?>
            <li>
  ...
  <?php 
    ...
    $data="select * from diamond_images";
