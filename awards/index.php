...
<a href="../index.php"><img src="../img/logo.png" alt=""></a>
	 <ul class="menu">
        <li><a href="index.php" class="main-menu" >最新消息</a>
            <ul>
                <li><a href="index.php">會務公告</a>
                </li>
...
<div class="main-body-fade">
    ...
    <a href="##" title=""><div class="button">實施辦法</div></a>
    <a href="##" title=""><div class="button" style="background-color: #333;color: #fff;">獎項項目</div></a>
	...
	<div class="line"></div>
		...
		<?php foreach ($articles as $article){ ?>
            <tr>
                <td class="years"><?php echo $article["years"];?></td>
                <td class="award""><?php echo $article["award"];?></td>
                <td class="winner""><?php echo $article["title"];?></td>
                <td class="unit"><?php echo $article["unit"];?><a class="tableLink" href="<?php echo $article['content']?>"><i class="fas fa-paperclip"></i></a></td>
            </tr>
