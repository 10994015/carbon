...
<head>
	...
	<link rel="stylesheet" href="../css/post_seminar.css">
...
<div class="main-body-fade">
    ...
    <a href="index.php" title=""><div class="button" style="background-color: #333;color: #fff;height:80px;line-height: 1.3;padding-top: 10px;box-sizing: border-box;">臺灣碳材料學術研討會</div></a>
    <a href="../abroad/index.php" title=""><div class="button">國內外研討會</div></a>
     <a href="../forum/index.php" title=""><div class="button">碳材料論壇</div></a>
     </div>
    <div class="container">
    ...
    <div class="line"></div>
      ...
      <h3><?php echo $seminar['article_title']; ?></h3> 
      <div class="seminarflex" style="">
    <span><?php echo $seminar['article_content']; ?></span>
     <a href="<?php echo $seminar['article_content2']; ?>">大會網站</a>
    </div>
            </p>
            </div>
            </div>
...
<?php 
    ...
    $data="select * from seminar_images";
