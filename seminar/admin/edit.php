...
if (isset($_SESSION['logged_in'])) {
		...
		$seminar = $query->fetch(PDO::FETCH_ASSOC);
...
<body>
	...
	<form method="POST" action="../includes/edit.php?id=<?php echo $id; ?>" accept-charset="utf-8">
		文章標題：<input type="text" name="title"   value=<?php echo $seminar['article_title']; ?>>
		<br>
		文章內容：<textarea name="content"><?php echo $seminar['article_content']; ?></textarea>
<br>
網站連結：<textarea name="content2"><?php echo $seminar['article_content2']; ?></textarea>
<br>
