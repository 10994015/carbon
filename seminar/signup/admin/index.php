...
<body>
	...
	<a href="index.php" title="" id="logo">碳材料論壇</a>
		...
		<!-- 印出文章 -->
		<?php if ($articles): ?>
			<?php foreach ($articles as $forum):?>
				<?php echo '<li>' ?>
				<?php echo $forum['article_title']; ?>
				<?php echo "<a href='edit.php?id=". $forum['article_id'] ."'>編輯</a>"?>
				<?php echo "<button onclick='del_func(". $forum['article_id'].")'>刪除</button>"?>
				<?php echo '<br>' ?>
				<?php echo '</li>' ?>
