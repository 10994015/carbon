...
<div class="main-body-fade">  
    ...
    <a href="../graphene/index.php" title=""><div class="button"  style="background-color: #333;color: #fff;">石墨烯</div></a>
    ...
    <h1 class="main-body-title">石墨烯專區</h1>
    </div>
    <div class="line"></div>
        ...
        <?php foreach ($graphene as $article){ ?>
            <li>
    ...
    $data="select * from graphene_images";
