...
if (isset($_SESSION['logged_in'])) {
		...
		$graphene = $query->fetch(PDO::FETCH_ASSOC);
...
<body>
	...
	<form method="POST" action="../includes/edit.php?id=<?php echo $id; ?>" accept-charset="utf-8">
		文章標題：<input type="text" name="title"   value=<?php echo $graphene['article_title']; ?>>
		<br>
		文章內容：<textarea name="content"><?php echo $graphene['article_content']; ?></textarea>
<br>
