...
<body>
	<div class="container">
	<a href="index.php" title="" id="logo">石墨烯專區</a>
		<br />
		<ol>
		...
		<!-- 印出文章 -->
		<?php if ($articles): ?>
			<?php foreach ($articles as $graphene):?>
				<?php echo '<li>' ?>
				<?php echo $graphene['article_title']; ?>
				<?php echo "<a href='edit.php?id=". $graphene['article_id'] ."'>編輯</a>"?>
				<?php echo "<button onclick='del_func(". $graphene['article_id'].")'>刪除</button>"?>
				<?php echo '<br>' ?>
				<?php echo '</li>' ?>
