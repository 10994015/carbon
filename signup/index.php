...
<head>
	...
	<link rel="stylesheet" href="../css/post_signup.css">
...
<div class="main-body-fade">  
    ...
    <a href="../abroad/index.php" title=""><div class="button">國內外研討會</div></a>
     ...
     <a href="../signup/index.php" title=""><div class="button" style="background-color: #333;color: #fff;">線上報名</div></a>
     </div>
    <div class="container">
    ...
    <div class="line"></div>
       ...
       <div class="display:flexl;flex-direction: column;">
                <a href="https://docs.google.com/forms/d/e/1FAIpQLSebTfdXaUtPdU4X-FTkMLDjFYOWwAd3f7vLOuWjws2ejF2-IA/viewform">我要報名</a>
            </div>
      </div>
     <?php 
    include_once('admin/uploads/connection.php');
    $data="select * from signup_images";
