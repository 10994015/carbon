...
$article= new Article;
$organization = $article->fetch_all();
 ?>
 <!DOCTYPE html>
...
<div class="main-body-fade">  
    ...
    <a href="index.php" title=""><div class="button" style="background-color: #333;color: #fff;">組織架構</div></a>
    ...
    <h1 class="main-body-title">組織架構</h1>
    </div>
    <div class="line"></div>
  ...
  <?php 
    ...
    $data="select * from organization_images";
    ...
    <?php
     ...
     ?> 
        <?php foreach ($organization as $article){ ?>
            <li>
