...
$article= new Article;
$diamond_like = $article->fetch_all();
 ?>
 <!DOCTYPE html>
...
<div class="main-body-fade">  
    ...
    <a href="../diamond_like/index.php" title=""><div class="button"  style="background-color: #333;color: #fff;">類鑽碳薄膜</div></a>
    ...
    <h1 class="main-body-title">類鑽碳薄膜專區</h1>
    </div>
    <div class="line"></div>
        ...
        <?php foreach ($diamond_like as $article){ ?>
            <li>
