...
<head>
	...
	<link rel="stylesheet" href="post_recommend.css">
...
<div class="main-body-fade">  
    ...
    while($row = mysqli_fetch_array($result)){?>
      ...
      <tr>
          <td style="height:60px;border: 1px #000 solid;padding:0 10px;text-decoration:underline">
          <a href="<?php echo 'admin/uploads/upload/'.$row['file_name'];?>" download="<?php $row['file_name'];?>">
          <?php echo $row['title']?>
          </a>
          </td>
          <td style="height:60px;border: 1px #000 solid;text-align:center;font-size:18px;">
            <a href="<?php echo 'admin/uploads/upload/'.$row['file_name'];?>" download="<?php $row['file_name'];?>"><i class="fas fa-download"></i></a>
          </td>
      </tr>
