...
<div class="main-body-fade">
  <div class="main-body-menu">
    ...
    <a href="index.php" title=""><div class="button" style="background-color: #333;color: #fff;">國內外研討會</div></a>
    ...
    <h1 class="main-body-title">國內外研討會</h1>
    </div>
    <div class="line"></div>
        <ol class="post">
        <?php foreach ($abroad as $article){ ?>
            <li>
