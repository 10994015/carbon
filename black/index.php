...
<div class="main-body-fade">
    ...
    <a href="../black/index.php" title=""><div class="button"  style="background-color: #333;color: #fff;">碳黑</div></a>
    ...
    <h1 class="main-body-title">碳黑專區</h1>
    </div>
    <div class="line"></div>
