...
<div class="main-body-fade">  
    ...
    <a href="../graphite/index.php" title=""><div class="button"  style="background-color: #333;color: #fff;">石墨</div></a>
    ...
    <h1 class="main-body-title">石墨專區</h1>
    </div>
    <div class="line"></div>
        ...
        <?php foreach ($graphite as $article){ ?>
            <li>
  ...
  <?php 
    ...
    $data="select * from graphite_images";
