...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/rwddatabase.css">
...
<div class="main-body-fade">  
  <div class="main-body-menu">
    <a href="index.php" title=""><div class="button" style="background-color: #333;color: #fff;">碳材料<br>人才資料庫</div></a>
     </div>
    <div class="container">
    <a href="index.php" title="" id="logo"></a>
    <div class="img-title">
    <img src="../img/CST Logo.png"  class="img-title-logo">
    <h1 class="main-body-title">碳材料人才資料庫</h1>
    </div>
    <div class="line"></div>
    <ul class="basetitle">
    
              <li  style="width: 100px;text-align: center;">姓名</li>
              <li  style="width: 200px;text-align: center;">服務單位</li>
              <li  style="width: 200px;text-align: center;">職稱</li>
              <li  style="width: 300px;text-align: center;">研究領域</li>
              <li  style="width: 200px;text-align: center;">相關連結</li>
                
</ul>
        <ol class="post">
        <?php foreach ($c_database as $article){ ?>
            <li>
            <div class="main-body-article">
              ...
              <li  style="width: 100px; text-align: center;"><?php echo $article['article_title']; ?></li>
             <li  style="width: 200px;  text-align: center;"> <?php echo $article['article_content']; ?></li>
              <li  style="width: 200px; text-align: center;">  <?php echo $article['article_content2']; ?></li>
              <li  style="width: 300px;"><?php echo $article['article_content3']; ?></li>
              <div>
              <a href="<?php echo $article['article_a']; ?>" target="_blank"><?php echo $article['article_content4']; ?></a>
              <a href="<?php echo $article['https']; ?>" target="_blank">網站連結</a>
               <a href="mailto:<?php echo $article['article_email']; ?>" title="">Email</a>
               </div>
