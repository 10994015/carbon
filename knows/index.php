...
<head>
	...
	<title>碳材知識＋</title>
	<link rel="stylesheet" href="../css/post_knows.css">
    ...
    <link rel="stylesheet" type="text/css" href="../css/rwdjoin.css">
...
<div class="main-body-fade">  
  <div class="main-body-menu">
    <a href="../newsknows/index.php" title=""><div class="button">碳材新知快訊</div></a>
     </div>
    <div class="container">
    <a href="index.php" title="" id="logo"></a>
    <div class="img-title">
    <img src="../img/CST Logo.png"  class="img-title-logo">
    <h1 class="main-body-title">碳材知識＋</h1>
    </div>
    <div class="line"></div>
        <ol class="post">
        <?php foreach ($knows as $article){ ?>
            <li>
