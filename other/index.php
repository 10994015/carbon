...
<div class="main-body-fade">  
    ...
    <a href="../other/index.php" title=""><div class="button"  style="background-color: #333;color: #fff;">其他碳材料</div></a>
    ...
    <h1 class="main-body-title">其他碳材料專區</h1>
    </div>
    <div class="line"></div>
