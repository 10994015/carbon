...
<div class="main-body-fade">
    ...
    <a href="../composite/index.php" title=""><div class="button"  style="background-color: #333;color: #fff;">碳複合材料</div></a>
    ...
    <h1 class="main-body-title">碳複合材料專區</h1>
    </div>
    <div class="line"></div>
        ...
        <?php foreach ($composite as $article){ ?>
            <li>
 ...
 <?php 
    ...
    $data="select * from composite_images";
