...
<div class="main-body-fade">   
  <div class="main-body-menu">
    <a href="../cms/index.php" title=""><div class="button">會務公告</div></a>
    <a href="index.php" title=""><div class="button" style="background-color: #333;color: #fff;">碳材​「探才」</div></a>
     </div>
    <div class="container">
    <a href="index.php" title="" id="logo"></a>
    <div class="img-title">
    <img src="../img/CST Logo.png"  class="img-title-logo">
    <h1 class="main-body-title">碳材​「探才」</h1>
    </div>
    <div class="line"></div>
        <ol class="post">
